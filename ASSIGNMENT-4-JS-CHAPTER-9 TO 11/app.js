...
// if(percentage >= 70){
// document.write("Total Marks: 300", "<br> Marks Obtained: 210" , "<br>Percentage: 70%", "<br>Grade: A" , " <br> Remarks: Good")
// }

// if(percentage >= 60){
// document.write("Total Marks: 300", "<br> Marks Obtained: 180" , "<br>Percentage: 60%", "<br>Grade: B" , " <br> Remarks: You Need to improve")
// }
    
// if(percentage < 60){
// document.write("Total Marks: 300", "<br> Marks Obtained: 174" , "<br>Percentage: 58%", "<br>Grade: Fail" , " <br> Remarks: Sorry")
//}
